...
Organizations are rapidly adopting AI tools (ChatGPT, Claude, Copilot, Midjourney, etc.) across teams — often without centralized visibility into who's using what, how much it costs, and whether usage stays within approved limits. This is the **"Shadow AI"** problem. 🕵️
...
Just open `ai-governance-dashboard.html` directly in any browser — double-click it, or right-click → Open with → your browser of choice. No setup required. ✅
